...
* Infrastructure in `settings.py`, `settings_storage.py`, `exporter.py`, `importer.py`, `updater.py`, `qrz_lookup.py`, `nvda_notify.py`, `i18n.py`, `logger.py`, `welcome_dialog.py`
...
* Keep settings stored as codes, not translated text.
