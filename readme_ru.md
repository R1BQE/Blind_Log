...
- **Импорт из формата ADIF**  
  Поддерживается импорт QSO из ADIF-файлов, экспортированных другими программами для ведения журнала (UR5EQF Log, Ham Radio Deluxe, Log4OM и другими). При импорте можно выбрать режим: заменить текущий журнал полностью или добавить записи к существующим с автоматической проверкой дублей.
...
- **Ctrl+O** — Импортировать ADIF-файл
